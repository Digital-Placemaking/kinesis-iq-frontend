...
const Share = () => {
  ...
  const shareTitle = `${coupon.title} - Exclusive Coupon`;
  const shareDescription = coupon.description || `Claim your ${coupon.discount} coupon now!`;
  const shareImage = coupon.image_url || '/lovable-uploads/anthony-perruzza-logo.jpg';
