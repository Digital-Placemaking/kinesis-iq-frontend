...
export const useSentimentQuestion = (partnerId?: string, surveyId?: string) => {
  ...
  const fetchQuestions = async () => {
    ...
    try {
      ...
      // Get all active questions, optionally filtered by partner or survey
      let query = supabase
  ...
  }, [partnerId, surveyId]); // Re-fetch when partnerId or surveyId changes
