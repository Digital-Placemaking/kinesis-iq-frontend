...
const QuestionDialog: React.FC<QuestionDialogProps> = ({
  ...
  // Fetch partners and surveys for dropdowns
  useEffect(() => {
      ...
      <DialogContent className="sm:max-w-[550px] max-h-[90vh] flex flex-col">
        ...
        <div className="grid gap-4 py-4 overflow-y-auto flex-1">
          ...
          <div className="grid gap-2">
            ...
            <Select
              value={currentQuestion?.survey_id || 'none'}
              onValueChange={value => setCurrentQuestion(prev => 
                prev ? { ...prev, survey_id: value === 'none' ? undefined : value } : null
              )}
            >
            ...
            <p className="text-xs text-muted-foreground">
              Assign this question to a specific survey
            </p>
          </div>
