          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.min(100, engagementData.visits > 0 ? (partnerData.total_responses / engagementData.visits) * 100 : 0)}%` }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.min(100, engagementData.visits > 0 ? (engagementData.copy_clicks / engagementData.visits) * 100 : 0)}%` }}
              ></div>
            </div>
            ...
            <div className="w-full bg-gray-200 rounded-full h-2 overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.min(100, engagementData.visits > 0 ? ((engagementData.download_clicks + engagementData.wallet_adds) / engagementData.visits) * 100 : 0)}%` }}
              ></div>
            </div>
          </div>
        </CardContent>
